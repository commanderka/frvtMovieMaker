...
if __name__ == '__main__':
    ...
    algoInfo1 = AlgorithmInfo("sampleAlgo001",os.path.join(baseDir,"edbs"),implDir = baseDir,libName = "libfrvt_1N_sampleAlgo_001.so", enrollmentDir=os.path.join(baseDir,"enroll"))
